...
for antenna_type in antenna_types:
    ...
    for atenna_permutation in atenna_permutations:
        ...
        antinode_location = [atenna_permutation[0][0], atenna_permutation[0][1]]
        while antinode_location[0] < length and antinode_location[0] >= 0 and antinode_location[1] < length and antinode_location[1] >= 0:
            antinode_map[antinode_location[0]][antinode_location[1]] = "#"
            antinode_location = [antinode_location[0] + inverse_vector[0], antinode_location[1] + inverse_vector[1]]
